...
.node-copy{display:flex;flex-direction:column;gap:4px;min-width:0;flex:1}.node-copy strong{font-weight:500;font-size:14px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.node-copy small{font-size:12px;color:#89abc1;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.hub{width:210px;min-height:80px;background:#10344a}.root{width:205px;min-height:95px;background:#174556;border-color:#4c8192}.root .node-copy strong{font-size:16px}:global(.node-arrow){color:#89abc1}
:global(.svelte-flow__handle){width:5px;height:5px;background:#818b86;border:1px solid #242827;min-width:5px;min-height:5px}
.compact{width:160px;min-height:62px;padding:9px;gap:8px}.compact.hub{width:145px;min-height:62px}.compact.root{width:175px;min-height:74px}.compact .node-icon{width:25px;height:28px}.compact .node-copy strong{font-size:12px}.compact .node-copy small{font-size:11px}
</style>
