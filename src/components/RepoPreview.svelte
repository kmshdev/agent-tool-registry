...
{/if}
<style>
.repo-preview{position:fixed;z-index:100;width:360px;max-width:calc(100vw - 24px);background:linear-gradient(150deg,#353631,#22231f);color:#efefe8;border:1px solid #ffffff30;border-radius:24px;box-shadow:0 0 0 1px #151610,0 22px 65px #171a1855,inset 0 1px 1px #ffffff12;font-family:var(--mono);overflow:hidden}
.preview-top{height:48px;margin:0 16px;border-bottom:1px solid #ffffff15;display:flex;align-items:center;justify-content:space-between;color:#a5a79d;font-size:var(--type-10)}.preview-top span{display:flex;gap:8px;align-items:center}.repo-preview button{cursor:pointer}.preview-top button{display:grid;place-items:center;width:32px;height:32px;border:1px solid #ffffff10;background:#ffffff09;color:#ccc;border-radius:50%}.preview-content{padding:17px 22px}.preview-folder{float:right;width:47px;height:43px;background:linear-gradient(#93bafe,#4a83e5);border-radius:10px;color:#eaf2ff;box-shadow:inset 0 1px 2px #fff9,0 5px 12px #0004;display:grid;place-items:center}.preview-content small{font-size:var(--type-10);color:#999c91}.preview-content h2{font-size:var(--type-20);line-height:1.25;text-wrap:balance;font-weight:500;color:#f2f2ec;margin:5px 55px 12px 0;overflow-wrap:anywhere}.preview-content p{font-size:var(--type-12);line-height:1.6;color:#c1c3b9;margin:0 0 14px;display:-webkit-box;-webkit-line-clamp:3;line-clamp:3;-webkit-box-orient:vertical;overflow:hidden}.preview-tags{display:flex;gap:5px;overflow:hidden}.preview-tags span{border-radius:12px;padding:4px 8px;background:#ffffff0a;color:#b7d8ad;font-size:var(--type-10);white-space:nowrap}.preview-meta{display:flex;align-items:center;flex-wrap:wrap;gap:9px 13px;margin-top:17px;font-size:var(--type-10);color:#a5a89d}.preview-meta span{display:flex;align-items:center;gap:5px}.preview-meta i{width:6px;height:6px;border-radius:50%;background:#84bcf8}.preview-footer{border-top:1px solid #ffffff15;padding:12px 16px;display:flex;justify-content:space-between;gap:10px}.preview-footer button,.preview-footer a{display:flex;align-items:center;justify-content:center;gap:8px;font-size:var(--type-10);border-radius:20px;padding:9px 13px;color:#dedfd6;background:linear-gradient(#494b44,#363831);border:1px solid #ffffff20;text-decoration:none;box-shadow:inset 0 1px 1px #ffffff10}.preview-footer a{background:#e9ebe3;color:#262922}.repo-preview :focus-visible{outline:2px solid #9acaff;outline-offset:2px}
</style>
